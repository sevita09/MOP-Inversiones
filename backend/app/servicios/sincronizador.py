...
def sincronizar_en_background() -> bool:
    ...
    def _correr():
        ...
        from app.servicios.inflacion import generar_retornos, sincronizar_inflacion
        ...
        try:
            ...
            try:
                ...
                generar_retornos(conexion)  # la inflación como serie correlacionable
