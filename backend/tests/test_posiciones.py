...
def test_los_lotes_en_usd_usan_el_ccl_de_su_fecha(conexion):
    ...
    _operacion(conexion, "compra", 100, 1000, "2026-01-10")  # CCL 1000 → US$1
    _operacion(conexion, "compra", 100, 3000, "2026-06-10")  # CCL 1500 → US$2
    guardar_tasas(
        conexion,
        [
    ...
    assert [l["precio"] for l in datos["lotes"]] == [1, 2]
    assert datos["ppc"] == 1.5  # promedio ponderado en dólares
    # En pesos el promedio es otro: 2000, y pasarlo por un CCL no daría 1,5
